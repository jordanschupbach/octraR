...
{
  {
    ...
    arg2 = static_cast< double >(REAL(s_m_radius)[0]);
...
SWIGEXPORT SEXP
R_swig_Circle_m_radius_get ( SEXP self, SEXP s_swig_copy)
{
  {
    double result;
    Circle *arg1 = 0 ;
...
{
  {
    ...
    arg1 = static_cast< double >(REAL(radius)[0]);
    result = (Circle *)new Circle(arg1);
    r_ans = SWIG_R_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_Circle, SWIG_POINTER_OWN |  0 );
    vmaxset(r_vmax);
    if(r_nprotect)  Rf_unprotect(r_nprotect);
...
SWIGINTERN swig_type_info _swigt__p_Circle = {"_p_Circle", "Circle *", 0, 0, (void*)0, 0};
